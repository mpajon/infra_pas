...
SOURCE_REPO_URL="${GIT_PROTOCOL_SOURCE}${GIT_USER_SOURCE}:${GIT_TOKEN_SOURCE}@${GIT_URL_SOURCE}${PROJECT_NAME_INETUM}"
DESTINATION_REPO_URL="${GIT_JUSTICIA_PROTOCOL_DESTINATION}${GIT_JUSTICIA_USER_DESTINATION}:${GIT_JUSTICIA_TOKEN_DESTINATION}@${GIT_JUSTICIA_URL_DESTINATION}${PROJECT_NAME_PAS}"
